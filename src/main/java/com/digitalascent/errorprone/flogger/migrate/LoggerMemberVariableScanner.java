...
final class LoggerMemberVariableScanner extends TreeScanner<Void, VisitorState> {
    ...
    LoggerMemberVariableScanner(Predicate<VariableTree> loggerVariablePredicate) {
