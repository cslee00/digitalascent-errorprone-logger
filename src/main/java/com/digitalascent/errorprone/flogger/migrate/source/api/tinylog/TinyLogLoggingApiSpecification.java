...
import static com.digitalascent.errorprone.flogger.migrate.source.api.tinylog.TinyLogMatchers.loggerImports;
import static com.digitalascent.errorprone.flogger.migrate.source.api.tinylog.TinyLogMatchers.loggingMethod;
import static com.digitalascent.errorprone.flogger.migrate.source.api.tinylog.TinyLogMatchers.throwableType;
...
public final class TinyLogLoggingApiSpecification extends AbstractLoggingApiSpecification {
    ...
    public FloggerLogStatement parseLoggingMethod(MethodInvocation methodInvocation,
        ...
        ExpressionTree throwableArgument = argumentParser.extractIfMatches(
                argument ->  throwableType().matches(argument, methodInvocation.state()));
