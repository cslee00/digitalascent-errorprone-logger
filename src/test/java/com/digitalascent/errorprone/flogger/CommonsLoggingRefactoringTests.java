...
class CommonsLoggingRefactoringTests extends AbstractLoggerApiFactoringTest {
    ...
    public void commonsLoggingTests(TestSpec testSpec) {
    ...
    static Stream<TestSpec> testDataProvider() {
        ...
        for (LogLevel logLevel : logLevels) {
            testSpecs.add(logLevel, "simple, unformatted message",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "collapse conditional",
                    (builder, logger) -> {
                        builder.beginControlFlow("if( $N.is$LEnabled() )", logger, Character.toUpperCase(logLevel.sourceLogLevel().charAt(0)) + logLevel.sourceLogLevel().substring(1));
                        builder.addStatement("$N.$L($S)", logger, logLevel.sourceLogLevel(), "test message");
            ...
            testSpecs.add(logLevel, "integer message format",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel,  "string concatenation",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "object as message",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "throwable as last argument with simple message",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "throwable as last argument with object message",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "throwable as only argument",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "unpack String.format",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "unpack String.format w/ Throwable",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "unpack Message.format",
                    (builder, logger) ->
            ...
            testSpecs.add(logLevel, "unpack Message.format w/ Throwable",
                    (builder, logger) ->
